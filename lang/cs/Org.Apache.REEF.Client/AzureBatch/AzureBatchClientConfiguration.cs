...
namespace Org.Apache.REEF.Client.AzureBatch
{
    ...
    /// </summary>
    public sealed class AzureBatchClientConfiguration : ConfigurationModuleBuilder
    {
        ...
        public static ConfigurationModule ConfigurationModule = new AzureBatchClientConfiguration()
