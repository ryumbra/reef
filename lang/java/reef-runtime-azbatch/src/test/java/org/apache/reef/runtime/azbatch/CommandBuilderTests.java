...
public class CommandBuilderTests {
  ...
  public void linuxCommandBuilderDriverTest() throws InjectionException {
    ...
    String expected =
        "/bin/sh -c \"ln -sfn '.' 'reef'; unzip local.jar; {{JAVA_HOME}}/bin/java -Xmx100m -XX:PermSize=128m " +
  ...
  public void linuxCommandBuilderShimEvaluatorTest() throws InjectionException {
    ...
    String expected = "/bin/sh -c \"ln -sfn '.' 'reef'; unzip local.jar; {{JAVA_HOME}}/bin/java -Xmx1m " +
